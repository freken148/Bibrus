<?php
    ...
    function SelectKlasy() {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<option class='optionGlobal optionFrekwencja' value='" . $row["id_klasy"] . "' $selected>" . htmlspecialchars($row["nazwa"]) . "</option>";
        }
    }
    ...
    function SelectUcznie() {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<option class='optionGlobal optionFrekwencja' value='" . $row['id_ucznia'] . "' $selected>" . htmlspecialchars($row['imie'] . ' ' . $row['nazwisko'] . ' ' . $row["nazwa"]) . "</option>";
        }
    }
